...
type ComplexityRoot struct {
	...
	Mutation struct {
		RunAction func(childComplexity int, actionID string) int
	}
...
type MutationResolver interface {
	RunAction(ctx context.Context, actionID string) (*string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.runAction":
		...
		return e.complexity.Mutation.RunAction(childComplexity, args["actionId"].(string)), true
...
func (ec *executionContext) _Mutation_runAction(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_runAction(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().RunAction(rctx, fc.Args["actionId"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_runAction(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_runAction_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Query_actions(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAction2ᚕᚖgithubᚗcomᚋlaunchrctlᚋwebᚋserverᚋgraphᚋmodelᚐAction(ctx, field.Selections, res)
}
	...
	for i, field := range fields {
		...
		case "runAction":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_runAction(ctx, field)
			})
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
...
func (ec *executionContext) marshalNAction2ᚕᚖgithubᚗcomᚋlaunchrctlᚋwebᚋserverᚋgraphᚋmodelᚐAction(ctx context.Context, sel ast.SelectionSet, v []*model.Action) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOAction2ᚖgithubᚗcomᚋlaunchrctlᚋwebᚋserverᚋgraphᚋmodelᚐAction(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOAction2ᚖgithubᚗcomᚋlaunchrctlᚋwebᚋserverᚋgraphᚋmodelᚐAction(ctx context.Context, sel ast.SelectionSet, v *model.Action) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
